...
PROTOBUF_CONSTEXPR employee::employee(
  ...
  , /*decltype(_impl_.is_enrolled_)*/false
...
static ::_pb::Metadata file_level_metadata_employee_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_employee_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_employee_2eproto = nullptr;
...
const uint32_t TableStruct_employee_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::employee, _impl_.company_id_),
  PROTOBUF_FIELD_OFFSET(::employee, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::employee, _impl_.address_),
  PROTOBUF_FIELD_OFFSET(::employee, _impl_.is_enrolled_),
};
...
const char descriptor_table_protodef_employee_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\022\022\n\ncompany_id\030\002 \001(\004\022\014\n\004name\030\003 \001(\t\022\017\n\007ad"
  "dress\030\004 \001(\t\022\023\n\013is_enrolled\030\005 \001(\010b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_employee_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_employee_2eproto = {
    false, false, 120, descriptor_table_protodef_employee_2eproto,
    "employee.proto",
    &descriptor_table_employee_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_employee_2eproto::offsets,
    file_level_metadata_employee_2eproto, file_level_enum_descriptors_employee_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_employee_2eproto(&descriptor_table_employee_2eproto);
...
employee::employee(const employee& from)
  ...
  ::memcpy(&_impl_.id_, &from._impl_.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.is_enrolled_) -
    reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.is_enrolled_));
...
// @@protoc_insertion_point(message_clear_start:employee)
  ...
  ::memset(&_impl_.id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.is_enrolled_) -
      reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.is_enrolled_));
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "employee.address"));
        } else
          goto handle_unusual;
        continue;
      // bool is_enrolled = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _impl_.is_enrolled_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* employee::_InternalSerialize(
  ...
  // bool is_enrolled = 5;
  if (this->_internal_is_enrolled() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_is_enrolled(), target);
  }
...
void employee::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_is_enrolled() != 0) {
    _this->_internal_set_is_enrolled(from._internal_is_enrolled());
  }
...
void employee::InternalSwap(employee* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(employee, _impl_.is_enrolled_)
      + sizeof(employee::_impl_.is_enrolled_)
      - PROTOBUF_FIELD_OFFSET(employee, _impl_.id_)>(
